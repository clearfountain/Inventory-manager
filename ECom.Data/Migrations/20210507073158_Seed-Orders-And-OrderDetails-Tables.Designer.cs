...
namespace ECom.Data.Migrations
{
    ...
    [Migration("20210507073158_Seed-Orders-And-OrderDetails-Tables")]
    partial class SeedOrdersAndOrderDetailsTables
    {
            ...
            modelBuilder.Entity("ECore.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 1,
                            Time = new DateTime(2021, 5, 7, 8, 31, 57, 622, DateTimeKind.Local).AddTicks(4324)
                        },
                        new
                        {
                            OrderId = 2,
                            CustomerId = 2,
                            Time = new DateTime(2021, 5, 7, 8, 31, 57, 623, DateTimeKind.Local).AddTicks(1408)
                        },
                        new
                        {
                            OrderId = 3,
                            CustomerId = 3,
                            Time = new DateTime(2021, 5, 7, 8, 31, 57, 623, DateTimeKind.Local).AddTicks(1446)
                        },
                        new
                        {
                            OrderId = 4,
                            CustomerId = 4,
                            Time = new DateTime(2021, 5, 7, 8, 31, 57, 623, DateTimeKind.Local).AddTicks(1448)
                        },
                        new
                        {
                            OrderId = 5,
                            CustomerId = 5,
                            Time = new DateTime(2021, 5, 7, 8, 31, 57, 623, DateTimeKind.Local).AddTicks(1450)
                        },
                        new
                        {
                            OrderId = 6,
                            CustomerId = 6,
                            Time = new DateTime(2021, 5, 7, 8, 31, 57, 623, DateTimeKind.Local).AddTicks(1451)
                        },
                        new
                        {
                            OrderId = 7,
                            CustomerId = 7,
                            Time = new DateTime(2021, 5, 7, 8, 31, 57, 623, DateTimeKind.Local).AddTicks(1452)
                        },
                        new
                        {
                            OrderId = 8,
                            CustomerId = 8,
                            Time = new DateTime(2021, 5, 7, 8, 31, 57, 623, DateTimeKind.Local).AddTicks(1454)
                        },
                        new
                        {
                            OrderId = 9,
                            CustomerId = 9,
                            Time = new DateTime(2021, 5, 7, 8, 31, 57, 623, DateTimeKind.Local).AddTicks(1455)
                        },
                        new
                        {
                            OrderId = 10,
                            CustomerId = 10,
                            Time = new DateTime(2021, 5, 7, 8, 31, 57, 623, DateTimeKind.Local).AddTicks(1456)
                        });
                });
